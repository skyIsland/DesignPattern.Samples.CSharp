...
namespace EDC.DesignPattern.Flyweight
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // 通过享元工厂获取2颗红子
            IgoChessman redChess1 = chessFactory.GetIgoChessman("r");
            IgoChessman redChess2 = chessFactory.GetIgoChessman("r");

            Console.WriteLine("判断两颗红子是否相同：{0}", object.ReferenceEquals(redChess1, redChess2));
            ...
            redChess1.Display(new Coordinates(1, 2));
            redChess2.Display(new Coordinates(1, 2));
